...
class PokemonsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sprite_shiny' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'sprite_back' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'sprite_shiny' => 'Lorem ipsum dolor sit amet',
                'sprite_back' => 'Lorem ipsum dolor sit amet',
                'created' => '2020-12-21 16:26:02',
                'modified' => '2020-12-21 16:26:02',
                'pokedex_number' => 1,
            ],
        ];
        parent::init();
